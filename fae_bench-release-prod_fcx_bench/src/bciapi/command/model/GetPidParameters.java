 ...
 *
 */
public class GetPidParameters extends CommandParent{
	...
	/**
	 * 
	 * Creates a object for class GetPidParameters.java
	 */
	public GetPidParameters(){
		super.command = PropertiesReaderUtil.getProperty("field.getpidparameters.val");
	}
